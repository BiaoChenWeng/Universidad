...
public class UsageExample {
	...
	public static final String INVALID_NULL_DATA_MESSAGE = "Invalid %s. %s can not be null";
	
	public static String DATA_NULL(String dataType) {
		return String.format(INVALID_NULL_DATA_MESSAGE, dataType, dataType);
	}
	...
	public static void main(String[] args) throws JSONException, FileNotFoundException {
		...
		System.out.println(DATA_NULL("si"));
		
		
		String id="hola";
		String gid="pepe";
		double Mass=2.4;
		Vector2D Position=new Vector2D(2.7,3.2);
		Vector2D Force= new Vector2D(83.1,24.0);
		
		String sonString = "{ \"id\": %s, \"m\": %s, \"p\": %s, \"v\": %s, \"f\": %s }".format(id,gid,Mass,Position,Force);		
		...
		//
		JSONObject FromString = new JSONObject();
		
		FromString.put("id", id);
		FromString.put("gid", gid);
		FromString.put("Mass", Mass);
		FromString.put("Position", Position.asJSONArray());
		...
		System.out.println(joFromFile1);
		
		//accessExample(joFromString);
		//accessExample(FromString);
		/*
